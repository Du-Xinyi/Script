...
# 安装其他工具及框架
sudo apt install -y vim net-tools git cmake make gcc python3-pip openssl libssl-dev
...
echo 'alias python="/usr/bin/python3"' >> /home/duxinyi/.bashrc
echo 'alias pip="/usr/bin/pip3"' >> /home/duxinyi/.bashrc
